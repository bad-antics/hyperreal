...
Traditional forensics asks: "What happened?"
Hyperreal asks: "What *could have* happened? What *should* exist but doesn't? What exists that *shouldn't be possible*?"

---

## ⚡ Unique Capabilities

### 🧠 Negative Space Forensics
...
sudo hyperreal --enable-temporal
```

## 📖 Usage

```bash
# Live memory questioning
